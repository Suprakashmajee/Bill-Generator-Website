...
export default function AboutUs() {
  return (
    <section id="about-us" className="py-16 md:py-24 bg-white border-t border-sky-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch max-w-6xl mx-auto">
          {[
            {
              icon: <Shield className="h-6 w-6 text-sky-700" />,
            ...
            {
              icon: <Award className="h-6 w-6 text-sky-700" />,
            ...
            <div
              key={index}
              className="bg-sky-50/25 rounded-2xl border border-sky-200/60 p-6 flex flex-col items-center text-center hover:bg-sky-50/50 transition-colors"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-sky-100 border border-sky-200 text-sky-700 mb-4">
                {item.icon}
              </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-sky-200 to-sky-300 p-8 md:p-12 rounded-3xl text-center max-w-4xl mx-auto shadow-md">
          ...
          <p className="text-xs md:text-sm text-sky-950 max-w-2xl mx-auto mt-2 font-medium leading-relaxed">
